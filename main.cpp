...
DigitalOut Ma(D10);  // Direction control pin Motot Input-1
DigitalOut Mb(D11);  // Direction control pin Motot Input-2
DigitalOut flash(D13);  // Flash onboard LED for indication
